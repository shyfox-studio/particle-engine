...
public sealed class RotationInterpolatorTests
{
    [Fact]
    public void Update_WhenAmountIsZero_SetsStartValue()
    {
        ...
        unsafe
        {
            ...
            Assert.Equal(1.0f, particle.Rotation, 0.000001f);
        }
    }
    ...
    public void Update_WhenAmountIsOne_SetsEndValue()
    {
        ...
        unsafe
        {
            ...
            Assert.Equal(0.0f, particle.Rotation, 0.000001f);
        }
    }
    ...
    public void Update_WhenAmountIsHalf_SetHalfValue()
    {
        ...
        unsafe
        {
            ...
            Assert.Equal(0.5f, particle.Rotation, 0.000001f);
        }
    }
}
